...
const token = '6125958880:AAEfdQB0vbkD9K7wZC7nOVufck9ejh59w_Y';
...
const start = () => {
    ...
    bot.on('message', async msg => {
        ...
        if(text === '/start') {
            ...
            return bot.sendMessage(chatId, `Добро пожаловать в LumosTelegramBot`);
        }

        if(text === '/info') {
            return bot.sendMessage(chatId, `Тебя зовут ${msg.from.first_name} \nЛогин твой ${msg.from.username}`);
        }
